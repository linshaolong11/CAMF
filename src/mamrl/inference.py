"""Module that defines different ways to run inference with MAMRL."""
...
from mamrl.model.memory import MemoryUsageEstimator
from mamrl.preprocessing import fit_preprocessing

if TYPE_CHECKING:
    from mamrl.model.preprocessing import SequentialFeatureTransformer
    from mamrl.model.transformer import PerFeatureTransformer
    from mamrl.preprocessing import EnsembleConfig


@dataclass
class InferenceEngine(ABC):
    """These define how mamrl inference can be run.
