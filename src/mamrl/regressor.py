"""MAMRLRegressor class.

!!! example
    ```python
    import sklearn.datasets
    from mamrl import MAMRLRegressor

    model = MAMRLRegressor()
...
from mamrl.model.bar_distribution import FullSupportBarDistribution
from mamrl.model.preprocessing import (
...
class MAMRLRegressor(RegressorMixin, BaseEstimator):
    """MAMRLRegressor class."""
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        """A MAMRL interface for regression.

        Args:
            n_estimators:
                The number of estimators in the MAMRL ensemble. We aggregate the
                predictions of `n_estimators`-many forward passes of MAMRL.
            ...
            device:
                The device to use for inference with MAMRL. If `"auto"`, the device is
    ...
    def fit(self, X: XType, y: YType) -> Self:
        ...
        self.model_, self.config_, self.bardist_ = initialize_mamrl_model(
