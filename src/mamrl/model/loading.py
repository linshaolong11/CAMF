...
from mamrl.model.encoders import (
...
class ModelSource:
    ...
    def get_classifier_v2(cls) -> ModelSource:
        filenames = [
            "mamrl-v2-classifier.ckpt",
            "mamrl-v2-classifier-gn2p4bpt.ckpt",
            "mamrl-v2-classifier-llderlii.ckpt",
            "mamrl-v2-classifier-od3j1g5m.ckpt",
            "mamrl-v2-classifier-vutqq28w.ckpt",
            "mamrl-v2-classifier-znskzxi4.ckpt",
        ]
        return cls(
            repo_id="Prior-Labs/MAMRL-v2-clf",
            default_filename="mamrl-v2-classifier.ckpt",
            filenames=filenames,
        )
    ...
    def get_regressor_v2(cls) -> ModelSource:
        filenames = [
            "mamrl-v2-regressor.ckpt",
            "mamrl-v2-regressor-09gpqh39.ckpt",
            "mamrl-v2-regressor-2noar4o2.ckpt",
            "mamrl-v2-regressor-5wof9ojf.ckpt",
            "mamrl-v2-regressor-wyl4o83o.ckpt",
        ]
        return cls(
            repo_id="Prior-Labs/MAMRL-v2-reg",
            default_filename="mamrl-v2-regressor.ckpt",
            filenames=filenames,
        )
...
def download_model(
    ...
    *,
    ...
    """Download a MAMRL model, trying all available sources.
...
def save_mamrl_model(model: nn.Module, save_path: Path | str) -> None:
