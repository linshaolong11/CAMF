...
from camf.model.encoders import (
...
class ModelSource:
    ...
    def get_classifier_v2(cls) -> ModelSource:
        filenames = [
            "camf-v2-classifier.ckpt",
            "camf-v2-classifier-gn2p4bpt.ckpt",
            "camf-v2-classifier-llderlii.ckpt",
            "camf-v2-classifier-od3j1g5m.ckpt",
            "camf-v2-classifier-vutqq28w.ckpt",
            "camf-v2-classifier-znskzxi4.ckpt",
        ]
        return cls(
            repo_id="Prior-Labs/CAMF-v2-clf",
            default_filename="camf-v2-classifier.ckpt",
            filenames=filenames,
        )
    ...
    def get_regressor_v2(cls) -> ModelSource:
        filenames = [
            "camf-v2-regressor.ckpt",
            "camf-v2-regressor-09gpqh39.ckpt",
            "camf-v2-regressor-2noar4o2.ckpt",
            "camf-v2-regressor-5wof9ojf.ckpt",
            "camf-v2-regressor-wyl4o83o.ckpt",
        ]
        return cls(
            repo_id="Prior-Labs/CAMF-v2-reg",
            default_filename="camf-v2-regressor.ckpt",
            filenames=filenames,
        )
...
def download_model(
    ...
    *,
    ...
    """Download a CAMF model, trying all available sources.
...
def save_camf_model(model: nn.Module, save_path: Path | str) -> None:
