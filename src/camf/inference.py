"""Module that defines different ways to run inference with CAMF."""
...
from camf.model.memory import MemoryUsageEstimator
from camf.preprocessing import fit_preprocessing

if TYPE_CHECKING:
    from camf.model.preprocessing import SequentialFeatureTransformer
    from camf.model.transformer import PerFeatureTransformer
    from camf.preprocessing import EnsembleConfig


@dataclass
class InferenceEngine(ABC):
    """These define how camf inference can be run.
