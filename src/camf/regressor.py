...
!!! example
    ...
    from camf import CAMFRegressor
...
from camf.model.bar_distribution import FullSupportBarDistribution
from camf.model.preprocessing import (
...
class CAMFRegressor(RegressorMixin, BaseEstimator):
    """CAMFRegressor class."""
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        """A CAMF interface for regression.

        Args:
            n_estimators:
                The number of estimators in the CAMF ensemble. We aggregate the
                predictions of `n_estimators`-many forward passes of CAMF.
            ...
            device:
                The device to use for inference with CAMF. If `"auto"`, the device is
    ...
    def fit(self, X: XType, y: YType) -> Self:
        ...
        self.model_, self.config_, self.bardist_ = initialize_camf_model(
